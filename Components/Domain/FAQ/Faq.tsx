...
const faq = [
  ...
  {
    question: "آیا می‌توانم رمز عبورم را تغییر دهم؟",
    answer: "بله. با مراجعه به قسمت پروفایل کاربری می‌توانید رمزعبور خود را تغییر دهید.",
  },
  {
    question: "چگونه می‌توانم پیامک‌های اطلاع‌رسانی را دریافت نمایم؟",
    answer: "با مراجعه به قسمت پروفایل کاربری می‌توانید شماره همراه خود را ثبت نمونده و پیامک دریافت نمایید.",
  },
  {
